...
var sinkGroup = Group(
	...
	PersistentFlags(func(flags *pflag.FlagSet) {
		...
		flags.String("provider-control-plane-endpoint", "", "Optional direct provider control-plane endpoint override for payment session management (e.g., 'https://gateway:9001?insecure=true')")
